...
public final class CompactModalPresentationController: UIPresentationController {
    ...
    private func computePresentedViewRect(
        traitCollection: UITraitCollection,
        sideMargin: CGFloat,
        containerView: UIView,
        totalVerticalMargin: CGFloat
    ) -> CGRect {
        ...
        case (.compact, .regular), (.regular, .regular):
            ...
            return CGRect(
                origin: point,
                size: CGSize(
                    width: containerView.frame.width - (2 * sideMargin),
